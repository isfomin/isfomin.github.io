...
/* harmony import */ var rxjs_add_operator_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/add/operator/map */ "./node_modules/rxjs-compat/_esm5/add/operator/map.js");
/* harmony import */ var _rest2_config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./rest2.config */ "./src/app/model/rest2.config.ts");
...
var RestDataSource = /** @class */ (function () {
    function RestDataSource(http) {
        this.http = http;
        this.baseUrl = _rest2_config__WEBPACK_IMPORTED_MODULE_4__["RestConfig"].url;
    }
    RestDataSource.prototype.authenticate = function (user, pass) {
        ...
        return this.http.request(new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Request"]({
            method: _rest2_config__WEBPACK_IMPORTED_MODULE_4__["RestConfig"].method == "POST" ? _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestMethod"].Post : _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestMethod"].Get,
            url: this.baseUrl + "login",
            body: { name: user, password: pass }
        })).map(function (response) {
            var r = response.json();
            _this.auth_token = r.success ? r.token : null;
            console.log(_this.auth_token);
            return r.success;
        });
    };
...
/***/ "./src/app/model/rest2.config.ts":
/*!***************************************!*\
  !*** ./src/app/model/rest2.config.ts ***!
  \***************************************/
/*! exports provided: RestConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
